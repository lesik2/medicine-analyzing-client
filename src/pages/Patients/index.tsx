...
export const PatientsPage = () => {
  const [idOfDeletedPatient, setIdOfDeletedPatient] = useState<string|undefined>(undefined)
  ...
  const { mutate, isPending,changeActiveStatus,isPendingDelete, deletePatient } = useMutatePatients({
    id: id,
    refetch: refetch,

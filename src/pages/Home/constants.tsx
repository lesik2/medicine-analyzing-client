...
export const config = {
  ...
  thirdSection: {
    title: (
      <>
        Запись на прием в<br /> Талон-Онлайн
      </>
    ),
    message:
      'Талон-Онлайн предлагает удобный способ записи на прием к врачам. Мы понимаем, как важно быстро и без лишних хлопот попасть на консультацию. С нашей платформой вы можете легко выбрать специалиста, удобное время и записаться на прием всего в несколько кликов.',
  },
} as const;
